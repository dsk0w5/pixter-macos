...
#define CPU_CORE_MASK						0x000000ff
#define CPU_CORE_ARM_V3						0x00000080
#define CPU_CORE_ARM_V4						0x00000081
#define CPU_CORE_ARM_V5						0x00000082

#define CPU_CORE_FTR_MASK					0x0000ff00
#define CPU_CORE_FTR_M						0x00000100
#define CPU_CORE_FTR_T						0x00000200
#define CPU_CORE_FTR_E						0x00000400
#define CPU_CORE_FTR_P						0x00000800
#define CPU_CORE_FTR_BASE_UPDATED_EXC_MODEL	0x00001000
#define CPU_CORE_FTR_CAN_CONFIG_ALIGN_CHECK	0x00002000	//capability to change the next setting
#define CPU_CORE_FTR_DEFAULT_ALIGN_CHECK	0x00004000	//default setting (maters if there is no way to switch)
#define CPU_CORE_FTR_PC_BIT_1_IMPL			0x00008000	//actually impl PC bit 1 (ARM7TDMI does) and cause havoc when "BX PC" is done at an addr not div by 4

#define CPU_SOC_TYPE_MASK					0x00f00000
#define CPU_SOC_TYPE_XSCALE					0x00100000	//XSCALE core extensions
#define CPU_SOC_TYPE_OMAP					0x00200000	//OMAP core extensions
#define CPU_SOC_TYPE_ARM					0x00300000	//no extensions - normal ARM core

struct ArmCpu* cpuInit(uint32_t pc, struct ArmMem *mem, uint32_t flags /* CPU_SOC_* mask */, int debugPort, uint32_t cpuid, uint32_t cacheId);
